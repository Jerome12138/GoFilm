# GoFilm UX Design v2 — 全面重构

> **版本** v2.0  
> **作者** UX Designer (BMAD `create-ux-design` workflow)  
> **日期** 2026-05-16  
> **范围** `client-v2/` 前端全量 UX 重构  
> **依据** PRD v1.0 (`doc/bmad/prd-redesign.md`) + 现状代码诊断  
...
**问题** P0/P1/P2 三轮重设计后视觉已接近 bilibili，但**信息架构散乱、空/错/loading 三态台词不齐、管理后台未统一风格、a11y 抽样缺失**。

**对策** 立"GoFilm v2 设计系统"作为新 source of truth：信息架构重排、扩 tokens、补完整状态机、整组件库、补 a11y。**不抛弃现有实现**，而是把 P0/P1/P2 产物纳入统一规范，缺什么补什么。
...
P0/P1/P2 已交付 11 项 bilibili 风格改造。**仍存的 8 类系统性 gap**：
...
*生成时间: 2026-05-16*  
*基线 commit: 19ec07c (refactor: 详情/播放职责去重 方案 A)*
